...
export const CONTRACT_ADDRESS = "0x204173d93b41D76c467D6A75856Ba03A3412B10d";

export const PREDICTION_MARKET_ABI = [
  // Read
  "function getMarket(uint256 marketId) view returns (tuple(address creator, uint48 createdAt, uint48 settledAt, bool settled, uint16 confidence, uint8 outcome, uint256 totalYesPool, uint256 totalNoPool, string question, string asset, uint256 targetPrice, uint256 settledPrice))",
